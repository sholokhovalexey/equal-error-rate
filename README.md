...
$`\frac{d}{d \pi} P_\mathrm{fa}(\pi) = \frac{d P_\mathrm{fa}}{dt} \Bigg|_{t=t_\mathrm{Bayes}} \cdot \frac{d t_\mathrm{Bayes}}{d\pi}`$

$`\frac{d}{d \pi}P_\mathrm{miss}(\pi) = \frac{d P_\mathrm{miss}}{dt} \Bigg|_{t=t_\mathrm{Bayes}} \cdot \frac{d t_\mathrm{Bayes}}{d\pi}`$
